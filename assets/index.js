...
function anexacss() {
  ...
  lnk.rel = 'stylesheet';
  lnk.type = 'text/css';
  lnk.href = 'assets/' + localStorage.getItem("tema");
...
function listacategorias(c) {
  conteudo = "<div class=links><a onclick=\"listacategorias('w');\">web</a> &nbsp; <a onclick=\"listacategorias('d');\">desktop</a> &nbsp; <a onclick=\"listacategorias('m');\">mobile</a> &nbsp; <img src='assets/dice.png' id='dice' onclick=\"location.hash=parseInt(Math.random()*procedimentos.length);\"></div><br>";
  animacao = 0;
